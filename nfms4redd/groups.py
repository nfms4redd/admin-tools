...
HELP = 'Maneja los grupos del fichero layers.json'
ADD = 'add'
GET = 'get'
DELETE = 'delete'
UPDATE = 'update'
...
def configure_parser(parser):
    ...
    get = subparsers.add_parser(GET, help='Obtiene información de un grupo',
                                description='Obtiene información de un grupo')
    ...
    add = subparsers.add_parser(ADD, help='Añade un nuevo grupo',
                                description='Añade un nuevo grupo')
...
def run(args, layers):
    ...
    if not args.groups_cmd:
        ...
        print('Se ha actualizado el grupo.')
    layers.save()
